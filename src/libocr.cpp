...
{
    return libocr::recognize(image_width, image_height, image_data, image_data_size, result, result_size);
}
int ocr_recognize_file_data(const char *image_data, int image_data_size, char *result, int result_size)
{
    return libocr::recognize(image_data, image_data_size, result, result_size);
}
int ocr_recognize_file(const char *image_file, char *result, int result_size)
{
    return libocr::recognize(image_file, result, result_size);
}
